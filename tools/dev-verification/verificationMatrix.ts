...
export const verificationMatrix = (): readonly MatrixCheck[] => [
  ...
  check('vendor-health-integration', 'session-cs', 'npx', ['playwright', 'test', '--config', 'tools/dev-verification/playwright.integration.config.ts', 'vendorHealth.test.ts', '--project=chromium-desktop', '--workers=1'], true),
  check('vendor-health-desktop', 'session-cs', 'npx', ['playwright', 'test', '--config', 'tools/dev-verification/playwright.config.ts', 'vendor-health.spec.ts', '--project=chromium-desktop', '--workers=1'], true),
  check('vendor-health-mobile', 'session-cs', 'npx', ['playwright', 'test', '--config', 'tools/dev-verification/playwright.config.ts', 'vendor-health.spec.ts', '--project=chromium-mobile', '--workers=1'], true),
  check('seller-center-integration', 'session-cs', 'npx', ['playwright', 'test', '--config', 'tools/dev-verification/playwright.integration.config.ts', 'sellerCenter.test.ts', '--project=chromium-desktop', '--workers=1'], true),
  check('seller-center-desktop', 'session-cs', 'npx', ['playwright', 'test', '--config', 'tools/dev-verification/playwright.config.ts', 'seller-center.spec.ts', '--project=chromium-desktop', '--workers=1'], true),
  check('seller-center-mobile', 'session-cs', 'npx', ['playwright', 'test', '--config', 'tools/dev-verification/playwright.config.ts', 'seller-center.spec.ts', '--project=chromium-mobile', '--workers=1'], true),
  ...
  check('giveaway-atomic', 'session-finance-policy', 'node', ['--import', 'tsx', '--test', 'tools/dev-verification/integration/giveawayAtomic.test.ts'], true),
    check('upload-security', 'session-cs-fault', 'node', ['--import', 'tsx', '--test', 'tools/dev-verification/integration/uploadSecurity.test.ts'], true),
