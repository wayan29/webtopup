...
import { ArrowLeft, Save, Image as ImageIcon, Info, Loader2, Clock, Tag, Settings, FileText, FolderOpen, Upload, X } from 'lucide-react';
            ...
            <div className="min-h-screen px-4 py-6">
                ...
                <div className="max-w-6xl mx-auto mb-6 flex items-center justify-between">
                    <button
                        ...
                        disabled={saving}
                        className="flex items-center gap-2 ui-text-muted hover:text-[var(--ui-text)] transition-colors disabled:cursor-not-allowed disabled:opacity-50"
                    >
                        <ArrowLeft className="w-5 h-5" />
                        <span className="font-medium">Kembali ke Daftar Jenis Produk</span>
                    </button>
                ...
                <div className="max-w-6xl mx-auto ui-panel-muted rounded-xl overflow-hidden shadow-2xl border ui-border">
                    <div className="p-8">
                        <form id="product-type-form" onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                            ...
                            <div className="space-y-8">
                                <section className="ui-panel border ui-border rounded-xl p-6 relative group hover:border-[var(--ui-accent)] transition-colors">
                                    ...
                                    <div className="space-y-5">
                                        <div>
                                            <label className="block text-xs font-medium ui-text-muted mb-1.5 uppercase tracking-wide">Nama Jenis Produk</label>
                                            <input
                                                type="text"
                                                required
                                                value={formData.name}
                                        ...
                                        <div className="grid grid-cols-2 gap-4">
                                            <div>
                                                <label className="block text-xs font-medium ui-text-muted mb-1.5 uppercase tracking-wide">Kategori</label>
                                                <select
                                                    required
                                                    value={formData.categoryId}
                                                    onChange={(e) => setFormData({ ...formData, categoryId: e.target.value, operatorId: '' })}
                                            ...
                                            <div>
                                                <label className="block text-xs font-medium ui-text-muted mb-1.5 uppercase tracking-wide">Operator</label>
                                                <select
                                                    required
                                        ...
                                        <div>
                                            <label className="block text-xs font-medium ui-text-muted mb-2 uppercase tracking-wide">Icon Produk</label>
                                        ...
                                        <div>
                                            <label className="block text-xs font-medium ui-text-muted mb-2 uppercase tracking-wide">Cover Image (Opsional)</label>
                                            <div className="flex gap-4">
                                                <div className="flex-shrink-0">
                                                        ...
                                                        {formData.cover ? (
                                                            <>
                                                                ...
                                                                <div className="absolute inset-0 bg-black/50 flex items-center justify-center opacity-0 group-hover/cover:opacity-100 transition-opacity">
                                                                    <button type="button" onClick={() => setFormData({ ...formData, cover: '' })} className="ui-danger-action rounded-full p-1.5">
                                                                        <X className="w-4 h-4" />
                                                                    </button>
                                                                </div>
                                                            </>
                                                ...
                                                <div className="flex-1 space-y-3">
                                                    ...
                                                    <label className={`block w-full text-center px-4 py-2.5 ui-panel-muted border ui-border rounded-lg text-sm ui-text-muted hover:bg-[var(--ui-panel-muted)] hover:text-[var(--ui-text)] cursor-pointer transition-colors ${uploading === 'cover' ? 'opacity-50 cursor-wait' : ''}`}>
                                                        {uploading === 'cover' ? <div className="flex items-center justify-center gap-2"><Loader2 className="w-4 h-4 animate-spin" /> Uploading...</div> : <div className="flex items-center justify-center gap-2"><Upload className="w-4 h-4" /> Upload File Baru</div>}
                                                        <input type="file" accept="image/*" className="hidden" onChange={handleFileUpload('cover')} disabled={uploading === 'cover'} />
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div className="space-y-8">
                                <section className="ui-panel border ui-border rounded-xl p-6 relative group hover:border-[var(--ui-accent)] transition-colors">
                                    <h4 className="flex items-center gap-2 text-base font-semibold ui-text mb-6 pb-2 border-b ui-border">
                                        <Settings className="w-4 h-4 ui-accent-text" /> Konfigurasi Operasional
                                    </h4>
                                    ...
                                    <div className="space-y-5">
                                        ...
                                        <div>
                                            <div className="flex items-center justify-between mb-2">
                                                <label className="block text-xs font-medium ui-text-muted uppercase tracking-wide">Jam Operasional</label>
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    />
                                                    <label htmlFor="open24Hours" className="text-xs ui-accent-text font-medium cursor-pointer select-none">Buka 24 Jam</label>
                                                </div>
                                            </div>
                                            <div className="grid grid-cols-2 gap-3">
                                                <div className="relative">
                                                    ...
                                                    <input
                                                        ...
                                                        className={`block w-full border ui-border rounded-lg py-2 pl-9 pr-3 ui-panel-muted ui-text text-sm focus:ring-1 focus:ring-[var(--ui-accent)] focus:border-[var(--ui-accent)] ${formData.open24Hours ? 'opacity-50 cursor-not-allowed' : ''}`}
                                        ...
                                        <div className="grid grid-cols-2 gap-4">
                                            <div>
                                                <label className="block text-xs font-medium ui-text-muted mb-1.5 uppercase tracking-wide">Status Produk</label>
                                                <select
                                                    value={formData.status ? 'active' : 'inactive'}
                                                    onChange={(e) => setFormData({ ...formData, status: e.target.value === 'active' })}
                                                    className={`block w-full border ui-border rounded-lg py-2 px-3 ui-panel-muted text-sm font-medium ${formData.status ? 'ui-success-text' : 'ui-text-muted'}`}
                                                >
                                            ...
                                            <div>
                                                <label className="block text-xs font-medium ui-text-muted mb-1.5 uppercase tracking-wide">Tipe Proses</label>
                                                <select
                                                    value={formData.processType}
                                                    onChange={(e) => setFormData({ ...formData, processType: e.target.value as 'auto' | 'manual' })}
                                        ...
                                        <div>
                                            <label className="block text-xs font-medium ui-text-muted mb-1.5 uppercase tracking-wide">Estimasi Pengiriman</label>
                                            <input
                                                type="text"
                                ...
                                <section className="ui-panel border ui-border rounded-xl p-6">
                                    <h4 className="flex items-center gap-2 text-base font-semibold ui-text mb-4 pb-2 border-b ui-border">
                                        <FileText className="w-4 h-4 ui-accent-text" /> Informasi Tambahan
                                    </h4>

                                    <div className="space-y-4">
                                        <div>
                                            <div className="flex justify-between items-center mb-1.5">
                                                <label className="block text-xs font-medium ui-text-muted uppercase tracking-wide">Deskripsi Form Akun</label>
                                                <div className="flex gap-1">
                                                    {/* Simple Formatting Toolbar Placeholders */}
                                        ...
                                        <div className="border-t ui-border pt-4 mt-2">
                                            <div className="flex items-center justify-between mb-3">
                                                ...
                                                <div className="relative inline-flex items-center cursor-pointer">
                                                    <input
                                                        ...
                                                        onChange={(e) => setFormData({ ...formData, popupInfo: { ...formData.popupInfo, enabled: e.target.checked } })}
                                                    />
                                            ...
                                            {formData.popupInfo.enabled && (
                                                <div className="space-y-3 animate-in fade-in slide-in-from-top-2 p-3 ui-panel-muted rounded-lg border ui-border">
                                                    <input
                                                        type="text"
                                                        value={formData.popupInfo.title}
                                                        onChange={(e) => setFormData({ ...formData, popupInfo: { ...formData.popupInfo, title: e.target.value } })}
                                                    ...
                                                    <textarea
                                                        ...
                                                        onChange={(e) => setFormData({ ...formData, popupInfo: { ...formData.popupInfo, content: e.target.value } })}
                                                        rows={2}
                                                    ...
                                                    <div className="grid gap-2 sm:grid-cols-2">
                                                        <input
                                                            ...
                                                            onChange={(e) => setFormData({ ...formData, popupInfo: { ...formData.popupInfo, buttonText: e.target.value } })}
                                                        ...
                                                        <input
                                                            ...
                                                            onChange={(e) => setFormData({ ...formData, popupInfo: { ...formData.popupInfo, buttonLink: e.target.value } })}
                                                            className="border ui-border rounded px-3 py-2 ui-panel ui-text text-xs"
                                                        ...
                                                        <input
                                                            ...
                                                            onChange={(e) => setFormData({ ...formData, popupInfo: { ...formData.popupInfo, image: e.target.value } })}
                        ...
                        <div className="mt-8 flex justify-end border-t ui-border pt-6">
                            <button
                                ...
                                disabled={saving || !formData.name.trim() || !formData.categoryId || !formData.operatorId}
